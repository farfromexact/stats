...
class StrategyBookActualSnapshotTest(unittest.TestCase):
    ...
    def test_20260820_control_totals(self):
        self.assert_control_totals(
            "2026-08-20",
            {
                "固收-配置盘": 5251.633069,
    ...
    def test_20260827_control_totals(self):
        self.assert_control_totals(
            "2026-08-27",
            {
                "固收-配置盘": 5235.543585,
    ...
    def test_20260831_control_totals(self):
        self.assert_control_totals(
            "2026-08-31",
            {
                "固收-配置盘": 5212.809468,
    ...
    def test_20260903_control_totals(self):
        self.assert_control_totals(
            "2026-09-03",
            {
                "固收-配置盘": 5213.499205,
    ...
    def test_20260910_control_totals(self):
        self.assert_control_totals(
            "2026-09-10",
            {
                "固收-配置盘": 5219.107424,
    ...
    def test_20260917_control_totals(self):
        self.assert_control_totals(
            "2026-09-17",
            {
                "固收-配置盘": 5222.550753,
